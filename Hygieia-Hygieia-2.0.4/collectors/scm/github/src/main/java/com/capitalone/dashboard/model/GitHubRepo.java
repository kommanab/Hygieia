...
public class GitHubRepo extends CollectorItem {
    private static final String REPO_URL ="https://github.com/SaurabhDev/NextGenAutomation.git";//"url"; // http://github.company.com/jack/somejavacode
    private static final String BRANCH = "master";//"branch"; // master, development etc.
    private static final String USER_ID = "saurabhdev01";
    private static final String PASSWORD = "SFOJava1";
